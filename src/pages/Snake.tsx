...
import { Box, Flex, Image, LoadingOverlay, Paper, SegmentedControl, Stack, Text, Title } from "@mantine/core";
import { GraphLinear } from "@/components/common/graphLine";
...
export function Snake() {
  ...
  return (
    <Stack align="flex-start" justify="flex-start" gap="lg" flex="1 1 100%">
