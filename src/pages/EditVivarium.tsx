...
import { composeInit, prepDiap } from "@/components/common/forms/Vivarium/const";
...
export function EditVivarium() {
  ...
  const composed = composeInit(viv);
  ...
  return (
    <Stack align="flex-start" justify="flex-start" gap="md" component="section">
      {isPending ? (
        ...
        <FormEditVivarium initData={composed} vivId={viv.id} initRat={prepDiap(viv.rat)} initMouse={prepDiap(viv.mouse)} />
      )}
    </Stack>
  );
}
