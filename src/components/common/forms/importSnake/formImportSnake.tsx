  ...
  return (
    <>
      ...
      <List type="ordered" size="sm">
        <List.Item>
          Изменить названия ваших категорий животных на следующие (в латинской раскладке). Для Региусов —{" "}
          <Highlight highlight={["bps", "bcs", "corns"]} highlightStyles={{ padding: "0 4px 0 4px" }}>
            указать bps, для удавов — bcs, для маисов — corns
          </Highlight>
        </List.Item>
