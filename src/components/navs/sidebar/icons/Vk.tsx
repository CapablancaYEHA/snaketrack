...
export const VkIcon: FC<IIcon> = ({ width, height, style }) => (
  <svg fill="none" width={width} height={height} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style={style}>
    <path
