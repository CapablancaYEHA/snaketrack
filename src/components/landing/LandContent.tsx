...
export const LandContent = () => {
  return (
    <Stack align="center" justify="flex-start" gap="sm" maw="100%" w="100%">
      ...
      <Space h="xl" />
      <Text ta="center" w="100%" fw={500} size="lg">
        Чуть заглянем в будущее
      </Text>
      <Text ta="center" w="100%" size="md">
        Вы же хотите знать реальное состояние рынка? Что сейчас популярно и что ищут люди, а что наоборот - невостребовано. Делать выводы и строить планы по составу коллекции не как карта ляжет, а на основе статистики и аналитики - не Европейского, не
        Американского рынка, а нашего. Все это будет возможно с внедрением функционала, который пока что в работе. Но чтобы это стало реальным и побыстрее, нужно больше Киперов на Маркете.
      </Text>
      <Space h="xl" />
    </Stack>
  );
